...
set output "test_voigt_precision.ps"
...
set xrange [ 8.97485e-06 : 1e-3] noreverse nowriteback
set x2range [ 8.97485e-06 : 0.00100564 ] noreverse nowriteback
set ylabel "| H_1(x) / ( 2 / sqrt({/Symbol p}) )|" 
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ 1.06850e-07 : 9546.82 ] noreverse nowriteback
set y2range [ 5.23225e-07 : 1788.32 ] noreverse nowriteback
set zlabel "" 
...
GNUTERM = "aqua"
pl 1 w l lt 2 lw 2 lc rgb "black" notitle, \
'test_voigt_precision.dat' u 1:(abs($2) / (2. / sqrt(pi))) w ste lt 1 lw 2 \
lc rgb "red" notitle
